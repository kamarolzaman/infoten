...
public class SectionTableAdapter extends ArrayAdapter<SubjectData> {
    ArrayList<SubjectData> mylist;
    public SectionTableAdapter(@NonNull Context context, int resource, ArrayList<SubjectData> myList) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        loc.setText(mylist.get(position).getDay());
        return v;
    }
}
